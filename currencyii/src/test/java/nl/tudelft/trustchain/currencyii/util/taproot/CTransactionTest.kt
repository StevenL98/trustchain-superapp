...
class CTransactionTest {
    ...
    fun taprootsignature() {
        ...
        val publicKey: ByteArray = "0014bdca1d681e5f2c8564b518ef85d6b9bf9bd43c6e".toByteArray()
        ...
        val publicKey2 =
            "512100e50574addc18523907058a69e4b3db029c19eb13e01d5278568abfada10686d4".toByteArray()
        ...
        val actual =
            TaprootSignatureHash(spending_tx, arrayOf(txVout), SIGHASH_ALL_TAPROOT, input_index = 0)
